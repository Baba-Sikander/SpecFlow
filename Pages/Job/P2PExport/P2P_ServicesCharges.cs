...
{
    class P2P_ServicesCharges : WebActions
    {
        ...
        {
            if (SectionHeading.GetAttribute("innerText").Contains(SectionHeaders))
            {
                Console.WriteLine("Section Header - " + SectionHeaders + "displayed");
            }
        }
    }
}